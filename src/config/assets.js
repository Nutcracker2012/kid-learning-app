...
export const assets = {
  images: {
    ...
    pteranodon: '/src/assets/Dino/Pteranodon.png',
    // Dino images from assets folder
    apatosaurus: '/src/assets/Dino/Apatosaurus.png',
    parasaurolophus: '/src/assets/Dino/Parasaurolophus.png',
    carnotaurus: '/src/assets/Dino/Carnotaurus.png',
    dilophosaurus: '/src/assets/Dino/Dilophosaurus.png',
    therizinosaurus: '/src/assets/Dino/herizinosauru.png',
    pachycephalosaurus: '/src/assets/Dino/Pachycephalosa.png',
    giganotosaurus: '/src/assets/Dino/Giganotosaurus.png',
    deinonychus: '/src/assets/Dino/Deinonychus.png',
    compsognathus: '/src/assets/Dino/Compsognathus.png',
    microraptor: '/src/assets/Dino/Microraptor.png',
    oviraptor: '/src/assets/Dino/viraptor.png',
    gallimimus: '/src/assets/Dino/Gallimimus.png',
    utahraptor: '/src/assets/Dino/Utahraptor.png',
    suchomimus: '/src/assets/Dino/Suchomimus.png',
    albertosaurus: '/src/assets/Dino/Albertosaurus.png',
    corythosaurus: '/src/assets/Dino/ Corythosaurus.png',
    protoceratops: '/src/assets/Dino/Protoceratops.png',
    maiasaura: '/src/assets/Dino/maiasaura.png',
    archaeopteryx: '/src/assets/Dino/Archaeopteryx.png',
    // Fruit images
