...
export const assets = {
  images: {
    ...
    pteranodon: '/src/assets/Dino/Tyrannosaurus Rex.png',
    // New dinosaurs using T-Rex image as placeholder
    apatosaurus: '/src/assets/Dino/Tyrannosaurus Rex.png',
    parasaurolophus: '/src/assets/Dino/Tyrannosaurus Rex.png',
    carnotaurus: '/src/assets/Dino/Tyrannosaurus Rex.png',
    dilophosaurus: '/src/assets/Dino/Tyrannosaurus Rex.png',
    therizinosaurus: '/src/assets/Dino/Tyrannosaurus Rex.png',
    pachycephalosaurus: '/src/assets/Dino/Tyrannosaurus Rex.png',
    giganotosaurus: '/src/assets/Dino/Tyrannosaurus Rex.png',
    deinonychus: '/src/assets/Dino/Tyrannosaurus Rex.png',
    compsognathus: '/src/assets/Dino/Tyrannosaurus Rex.png',
    microraptor: '/src/assets/Dino/Tyrannosaurus Rex.png',
    oviraptor: '/src/assets/Dino/Tyrannosaurus Rex.png',
    gallimimus: '/src/assets/Dino/Tyrannosaurus Rex.png',
    utahraptor: '/src/assets/Dino/Tyrannosaurus Rex.png',
    suchomimus: '/src/assets/Dino/Tyrannosaurus Rex.png',
    albertosaurus: '/src/assets/Dino/Tyrannosaurus Rex.png',
    corythosaurus: '/src/assets/Dino/Tyrannosaurus Rex.png',
    protoceratops: '/src/assets/Dino/Tyrannosaurus Rex.png',
    maiasaura: '/src/assets/Dino/Tyrannosaurus Rex.png',
    archaeopteryx: '/src/assets/Dino/Tyrannosaurus Rex.png',
    // Fruit images
